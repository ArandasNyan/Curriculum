...
window.addEventListener("scroll", scrollActive), window.addEventListener("scroll", scrollTop); 
...
resumeButton.addEventListener("click", (() => { scaleCv(), generateResume(), setTimeout(removeScale, 5e3) }));
